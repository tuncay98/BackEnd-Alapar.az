...
namespace AlApar.az.Areas.AP.Controllers
{
    ...
    public class AdsController : Controller
    {
        ...
        {
            var ads = db.Ads.Where(w=> w.StartDate==null).Include(a => a.Agent).Include(a => a.BuildingType).Include(a => a.Category).Include(a => a.City).Include(a => a.Profile).Include(a => a.Region).Include(a => a.RoomCount).Include(a => a.Village);
